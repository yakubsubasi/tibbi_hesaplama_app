...
import 'package:tibbi_hesaplama/View/widgets/optional_widget_view.dart';
        ...
        OptionalElement(
          ...
          children: [
            ...
            Option(
                ...
                score: 3),
            Option(
                title: 'Tanımlanamayan kelime ve sesler çıkartıyor', score: 2),
            Option(
              title: 'Ses yok',
              score: 1,
            )
